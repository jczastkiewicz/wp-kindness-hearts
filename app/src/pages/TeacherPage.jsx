...
export default function TeacherPage() {
    ...
    return (
      <div className="full-page" style={{ justifyContent: 'center', padding: 32 }}>
        <div className="card" style={{ maxWidth: 360, textAlign: 'center' }}>
          <div style={{ fontSize: '3rem', marginBottom: 16 }}><span aria-hidden="true">🔑</span></div>
  ...
  if (loadError) {
    return (
      <div className="full-page" style={{ justifyContent: 'center', padding: 32 }}>
        <div className="card" style={{ maxWidth: 360, textAlign: 'center' }}>
          <div style={{ fontSize: '2.5rem', marginBottom: 12 }}><span aria-hidden="true">⚠️</span></div>
  ...
  if (!classes.length) {
    return (
      <div className="full-page" style={{ justifyContent: 'center', padding: 32 }}>
        <div className="card" style={{ maxWidth: 360, textAlign: 'center' }}>
          <div style={{ fontSize: '2.5rem', marginBottom: 12 }}><span aria-hidden="true">🏫</span></div>
  ...
  return (
    ...
    >
      {/* Flash feedback */}
      {flash && <div className="feedback-flash"><span aria-hidden="true">❤️</span></div>}
      ...
      <div className="card" style={{ width: '100%', maxWidth: 380, textAlign: 'center' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: '2.5rem', lineHeight: 1 }}><span aria-hidden="true">❤️</span></div>
